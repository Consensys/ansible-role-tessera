...
| tessera_download_url             | ---                                        | URL to Tessera tar.                                                                                                                                                                                                                                |
| enclave_download_url             | ---                                        | URL to Enclave tar.                                                                                                                                                                                                                                |
| azure_key_vault_download_url     | ---                                        | URL to Azure Key Vault tar.                                                                                                                                                                                                                        |
| aws_key_vault_download_url       | ---                                        | URL to AWS Key Vault tar.                                                                                                                                                                                                                          |
| hashicorp_key_vault_download_url | ---                                        | URL to Hashicorp Key Vault tar.                                                                                                                                                                                                                    |
| libsodium_download_url           | ---                                        | URL to Libsodium tar.gz.                                                                                                                                                                                                                           |
...
| server_configs                   | []                                         | Refer to https://docs.tessera.consensys.net/en/stable/Reference/SampleConfiguration/#serverconfigs                                                                                                                                                 |
